  ...
  return (
    <div style={{fontFamily:FONT_SANS, maxWidth:680, margin:"0 auto", minHeight:"100vh", background:"#FAFAF8", paddingTop:"env(safe-area-inset-top)"}}>
      ...
      <div style={{background:"#FAFAF8", borderBottom:`0.5px solid #E8E0E0`}}>
        <div style={{margin:"4px 8px", padding:"2px 0"}}>
          <div style={{display:"flex", flexWrap:"wrap", justifyContent:"center", gap:"2px"}}>
            {TABS.map(t => (
              <button key={t.id} onClick={() => setActiveTab(t.id)}
                style={{padding:"6px 8px", border:"none", cursor:"pointer", fontSize:9, fontFamily:FONT_SANS, letterSpacing:0.8, textTransform:"uppercase", background: activeTab===t.id ? T.cardBg : "transparent", color: activeTab===t.id ? "#3A3A3A" : "#AAAAAA", borderRadius:16, transition:"all 0.2s", whiteSpace:"nowrap"}}>
                {t.label}
              </button>
            ))}
          </div>
